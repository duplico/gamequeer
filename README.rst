...
GameQueer is a sort of `Fantasy Console <https://en.wikipedia.org/wiki/Fantasy_video_game_\
console>`_, with a couple of twists. First, there is an actual console of sorts, in the form
