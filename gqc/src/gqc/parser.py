...
animation_definition_section = "animations" file_assignments
...
menu_definition = "menu" identifier menu_options
...
# Animation and lightcue sections
file_source = string
...
animation_definition_section = pp.Group(pp.Keyword("animations") - file_assignments)
...
menu_definition = pp.Group(pp.Keyword("menu") - identifier - menu_options)
